...
export { default as GitObjectMissingError } from './src/domain/errors/GitObjectMissingError.js';
export { default as GitRepositoryLockedError } from './src/domain/errors/GitRepositoryLockedError.js';
export { default as GitProtocolError } from './src/domain/errors/GitProtocolError.js';
...
export { default as UnsupportedCapabilityError } from './src/domain/errors/UnsupportedCapabilityError.js';
