...
- Inherited `PATH`: To locate the operator's Git binary.
...
Executable and configuration-discovery paths are inherited only; per-call
environment overrides cannot redirect them to caller-selected files or
directories.
